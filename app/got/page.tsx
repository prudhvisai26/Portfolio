...
//         {/* Animated Line */}
//         <motion.div
//           className="h-0.5 bg-linear-to-r from-transparent via-amber-500 to-transparent mt-10 relative overflow-hidden"
...
// // Lets be more creative instead of scrolling down to see the details why can't we do scrolling into the page like a 3D one like for example when we scroll down it should give me next part hiding behind my name vice-versa will it be good or shall we just put like this only?
